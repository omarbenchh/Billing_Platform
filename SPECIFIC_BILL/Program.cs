        ...
        static void Main(string[] args)
        {
            ...
            while (tim != 0)
            {
                ...
                foreach (string d in txtCSVFilePath)
                {
                    ...
                    TextReader tr = new StreamReader(txtCSVFolderPath + "\\" + to + ".txt");
                    string numero;
                    // read a line of text
                    numero = tr.ReadLine();
                    // close the stream
                    ...
                    for (int i = 0; i < csvData.Rows.Count - 1; i++)
                    {
                        ...
                        else if (csvData.Rows[i][4].ToString() == numero)
                        {
                    ...
                    SmtpServer.Port = 587;
                    SmtpServer.Credentials = new System.Net.NetworkCredential("your@email.com", "yourpassword");
                    ...
                    Console.WriteLine("\nLog File Updated !");
                    File.Delete(d);
                    File.Delete(txtCSVFolderPath + "\\" + to + ".txt");
